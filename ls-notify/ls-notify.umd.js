(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Observable'), require('rxjs/add/operator/share'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Observable', 'rxjs/add/operator/share', '@angular/animations'], factory) :
	(factory((global['ls-notify'] = {}),global.core,global.common,global.Observable,null,global.animations));
}(this, (function (exports,core,common,Observable,share,animations) { 'use strict';
...
var NotifycationService = (function () {
    function NotifycationService() {
        var _this = this;
        this.pushNotification = new Observable.Observable(function (observer) { return _this._pushNotification = observer; }).share();
        this.clearNotification = new Observable.Observable(function (observer) { return _this._clearNotification = observer; }).share();
    }
    /**
     * @param {?} notification
     * @return {?}
        ...
        { type: core.Component, args: [{
                    ...
                    animations: [
                        animations.trigger('animate', [
                            ...
                            animations.transition('void -> slide', [
                                animations.style({ opacity: 1, transform: 'translateY(100%)' }),
                                animations.animate('500ms ease-in', animations.style({ transform: 'translateY(0)' }))
                            ]),
                            animations.transition('slide -> void', [
                                animations.style({ opacity: 1, transform: 'translateY(0)' }),
                                animations.animate('500ms ease-out', animations.style({ transform: 'translateY(100%)' }))
                            ])
                        ])
                    ]
                },] },
...
exports.NotifycationComponent = NotifycationComponent;
exports.NotifycationService = NotifycationService;
